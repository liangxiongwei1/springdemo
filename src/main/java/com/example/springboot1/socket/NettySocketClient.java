...
//import com.intellif.smart.platformproperties.VanruiCloud;
//import com.intellif.smart.utils.GlobalConst;
...
//     * @param date 任务开始时间
//     */
//    public void startClient(String id, Date date) {
//        try {
...
//            // 指定每次执行任务的时间间隔
//            long period = 10000;
//            if(GlobalConst.VANRUI_ALIVETIME_ID.equals(id)){
//                period = VanruiCloud.aliveTime;
//                //中断时长判断
//                Object socketTime = redisTemplate.opsForValue().get("vanruiSocketTime");
//                Date newTime = sf.parse(sf.format(new Date()));
//                if(socketTime!=null && VanruiCloud.dataCacheTime!=0){
//                     Date oldTime = sf.parse(socketTime.toString());
//                     long dataCacheTime = VanruiCloud.dataCacheTime*60*1000;
//                     long time = newTime.getTime()-oldTime.getTime();
//                     if(time>dataCacheTime){
//                         vanruiCloud.fullSynchronizePerson();
//                     }
//                }else {
//                    vanruiCloud.fullSynchronizePerson();
//                }
//                redisTemplate.opsForValue().set("vanruiSocketTime",sf.format(newTime));
//            }
//            // 计算任务开始时间到当前时间的毫秒差
...
//            try {
//
//                if (null != onMessageContent) {
//                    if(GlobalConst.VANRUI_ALIVETIME_ID.equals(id)){
//                         message  = vanruiCloud.heartbeatTask();
//                    }
////                    logger.info("客户端发送消息：" + message.toString());
//                    socket.send(message);
//                }
//            } catch (Exception e) {
//                logger.error("心跳异常"+id+"_异常内容"+e.getMessage());
//            }
//        }
//    }
//
